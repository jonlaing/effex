...
[effex-monorepo](../../../modules.md) / [router/src](../README.md) / RouterContext

# Class: RouterContext

Defined in: [packages/router/src/router/RouterContext.ts:19](https://github.com/jonlaing/effex/blob/6a1b9c8b38e226609ce7e1a1f5173769b8aad981/packages/router/src/router/RouterContext.ts#L19)
...
- `TagClassShape`\<`"RouterContext"`, [`BaseRouter`](../interfaces/BaseRouter.md), `this`\>
...
`Context.Tag("RouterContext")< RouterContext, BaseRouter >().constructor`
...
> `readonly` **\_A**: `Covariant`\<[`BaseRouter`](../interfaces/BaseRouter.md)\>
...
> `readonly` **\_R**: `Covariant`\<`RouterContext`\>
...
> `readonly` **\_Identifier**: `Invariant`\<`RouterContext`\>

#### \_Service

> `readonly` **\_Service**: `Invariant`\<[`BaseRouter`](../interfaces/BaseRouter.md)\>
...
`Context.Tag("RouterContext")< RouterContext, BaseRouter >().stack`
...
`EffectGenerator`\<`Tag`\<`RouterContext`, [`BaseRouter`](../interfaces/BaseRouter.md)\>\>
...
`Context.Tag("RouterContext")< RouterContext, BaseRouter >().toString`
