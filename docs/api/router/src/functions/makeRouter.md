...
[effex-monorepo](../../../modules.md) / [router/src](../README.md) / makeRouter

# Function: makeRouter()

> **makeRouter**\<`Routes`\>(`routes`, `options?`): `Effect`\<[`RouterType`](../interfaces/RouterType.md)\<`Routes`\>, `never`, `Scope`\>

Defined in: [packages/router/src/router/Router.ts:40](https://github.com/jonlaing/effex/blob/6a1b9c8b38e226609ce7e1a1f5173769b8aad981/packages/router/src/router/Router.ts#L40)
