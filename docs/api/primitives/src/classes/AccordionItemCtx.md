...
[effex-monorepo](../../../modules.md) / [primitives/src](../README.md) / AccordionItemCtx

# Class: AccordionItemCtx

Defined in: [packages/primitives/src/primitives/Accordion/Accordion.ts:110](https://github.com/jonlaing/effex/blob/54ecd92e6ce2cfbeee604b727471aa18d6829626/packages/primitives/src/primitives/Accordion/Accordion.ts#L110)

Effect Context for individual Accordion.Item

## Extends

- `TagClassShape`\<`"AccordionItemContext"`, [`AccordionItemContext`](../interfaces/AccordionItemContext.md), `this`\>

## Constructors

### Constructor

> **new AccordionItemCtx**(`_`): `AccordionItemCtx`
...
`Context.Tag("AccordionItemContext")< AccordionItemCtx, AccordionItemContext >().constructor`
...
`Context.Tag("AccordionItemContext")< AccordionItemCtx, AccordionItemContext >().[TagTypeId]`
...
`Context.Tag("AccordionItemContext")< AccordionItemCtx, AccordionItemContext >().Id`

***

### Type

> `readonly` **Type**: [`AccordionItemContext`](../interfaces/AccordionItemContext.md)

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Context.d.ts:101

#### Inherited from

`Context.Tag("AccordionItemContext")< AccordionItemCtx, AccordionItemContext >().Type`
...
`Context.Tag("AccordionItemContext")< AccordionItemCtx, AccordionItemContext >()._op`

***

### \[ChannelTypeId\]

> `readonly` `static` **\[ChannelTypeId\]**: `VarianceStruct`\<`never`, `unknown`, `never`, `unknown`, [`AccordionItemContext`](../interfaces/AccordionItemContext.md), `unknown`, `AccordionItemCtx`\>

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Channel.d.ts:108

#### Inherited from

`Context.Tag("AccordionItemContext")< AccordionItemCtx, AccordionItemContext >().[ChannelTypeId]`

***

### \[EffectTypeId\]

> `readonly` `static` **\[EffectTypeId\]**: `VarianceStruct`\<[`AccordionItemContext`](../interfaces/AccordionItemContext.md), `never`, `AccordionItemCtx`\>

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Effect.d.ts:195

#### Inherited from

`Context.Tag("AccordionItemContext")< AccordionItemCtx, AccordionItemContext >().[EffectTypeId]`
...
`Context.Tag("AccordionItemContext")< AccordionItemCtx, AccordionItemContext >().[ignoreSymbol]`

***

### \[SinkTypeId\]

> `readonly` `static` **\[SinkTypeId\]**: `VarianceStruct`\<[`AccordionItemContext`](../interfaces/AccordionItemContext.md), `unknown`, `never`, `never`, `AccordionItemCtx`\>

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Sink.d.ts:82

#### Inherited from

`Context.Tag("AccordionItemContext")< AccordionItemCtx, AccordionItemContext >().[SinkTypeId]`
...
> `readonly` **\_A**: `Covariant`\<[`AccordionItemContext`](../interfaces/AccordionItemContext.md)\>
...
> `readonly` **\_R**: `Covariant`\<`AccordionItemCtx`\>

#### Inherited from

`Context.Tag("AccordionItemContext")< AccordionItemCtx, AccordionItemContext >().[STMTypeId]`

***

### \[StreamTypeId\]

> `readonly` `static` **\[StreamTypeId\]**: `VarianceStruct`\<[`AccordionItemContext`](../interfaces/AccordionItemContext.md), `never`, `AccordionItemCtx`\>

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Stream.d.ts:111

#### Inherited from

`Context.Tag("AccordionItemContext")< AccordionItemCtx, AccordionItemContext >().[StreamTypeId]`
...
> `readonly` **\_Identifier**: `Invariant`\<`AccordionItemCtx`\>

#### \_Service

> `readonly` **\_Service**: `Invariant`\<[`AccordionItemContext`](../interfaces/AccordionItemContext.md)\>
...
`Context.Tag("AccordionItemContext")< AccordionItemCtx, AccordionItemContext >().[typeSymbol]`

***

### \[unifySymbol\]?

> `static` `optional` **\[unifySymbol\]**: `TagUnify`\<`TagClass`\<`AccordionItemCtx`, `"AccordionItemContext"`, [`AccordionItemContext`](../interfaces/AccordionItemContext.md)\>\>

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Context.d.ts:45

#### Inherited from

`Context.Tag("AccordionItemContext")< AccordionItemCtx, AccordionItemContext >().[unifySymbol]`

***

### Identifier

> `readonly` `static` **Identifier**: `AccordionItemCtx`

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Context.d.ts:35

#### Inherited from

`Context.Tag("AccordionItemContext")< AccordionItemCtx, AccordionItemContext >().Identifier`

***

### key

> `readonly` `static` **key**: `"AccordionItemContext"`

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Context.d.ts:110

#### Inherited from

`Context.Tag("AccordionItemContext")< AccordionItemCtx, AccordionItemContext >().key`

***

### Service

> `readonly` `static` **Service**: [`AccordionItemContext`](../interfaces/AccordionItemContext.md)

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Context.d.ts:34

#### Inherited from

`Context.Tag("AccordionItemContext")< AccordionItemCtx, AccordionItemContext >().Service`
...
`Context.Tag("AccordionItemContext")< AccordionItemCtx, AccordionItemContext >().stack`

## Methods

### \[iterator\]()

> `static` **\[iterator\]**(): `EffectGenerator`\<`Tag`\<`AccordionItemCtx`, [`AccordionItemContext`](../interfaces/AccordionItemContext.md)\>\>

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Effect.d.ts:137

#### Returns

`EffectGenerator`\<`Tag`\<`AccordionItemCtx`, [`AccordionItemContext`](../interfaces/AccordionItemContext.md)\>\>

#### Inherited from

`Context.Tag("AccordionItemContext")< AccordionItemCtx, AccordionItemContext >().[iterator]`
...
`Context.Tag("AccordionItemContext")< AccordionItemCtx, AccordionItemContext >().[NodeInspectSymbol]`

***

### context()

> `static` **context**(`self`): `Context`\<`AccordionItemCtx`\>
...
`Context`\<`AccordionItemCtx`\>

#### Inherited from

`Context.Tag("AccordionItemContext")< AccordionItemCtx, AccordionItemContext >().context`

***

### of()

> `static` **of**(`self`): [`AccordionItemContext`](../interfaces/AccordionItemContext.md)
...
`Context.Tag("AccordionItemContext")< AccordionItemCtx, AccordionItemContext >().of`
...
`Context.Tag("AccordionItemContext")< AccordionItemCtx, AccordionItemContext >().pipe`
...
`Context.Tag("AccordionItemContext")< AccordionItemCtx, AccordionItemContext >().toJSON`
...
`Context.Tag("AccordionItemContext")< AccordionItemCtx, AccordionItemContext >().toString`
