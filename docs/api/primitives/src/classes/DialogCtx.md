...
[effex-monorepo](../../../modules.md) / [primitives/src](../README.md) / DialogCtx

# Class: DialogCtx

Defined in: [packages/primitives/src/primitives/Dialog/Dialog.ts:107](https://github.com/jonlaing/effex/blob/6a1b9c8b38e226609ce7e1a1f5173769b8aad981/packages/primitives/src/primitives/Dialog/Dialog.ts#L107)

Effect Context for Dialog state sharing between parts.

## Extends

- `TagClassShape`\<`"DialogContext"`, [`DialogContext`](../interfaces/DialogContext.md), `this`\>

## Constructors

### Constructor

> **new DialogCtx**(`_`): `DialogCtx`
...
`Context.Tag("DialogContext")< DialogCtx, DialogContext >().constructor`
...
`Context.Tag("DialogContext")< DialogCtx, DialogContext >().[TagTypeId]`
...
`Context.Tag("DialogContext")< DialogCtx, DialogContext >().Id`

***

### Type

> `readonly` **Type**: [`DialogContext`](../interfaces/DialogContext.md)

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Context.d.ts:101

#### Inherited from

`Context.Tag("DialogContext")< DialogCtx, DialogContext >().Type`
...
`Context.Tag("DialogContext")< DialogCtx, DialogContext >()._op`

***

### \[ChannelTypeId\]

> `readonly` `static` **\[ChannelTypeId\]**: `VarianceStruct`\<`never`, `unknown`, `never`, `unknown`, [`DialogContext`](../interfaces/DialogContext.md), `unknown`, `DialogCtx`\>

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Channel.d.ts:108

#### Inherited from

`Context.Tag("DialogContext")< DialogCtx, DialogContext >().[ChannelTypeId]`

***

### \[EffectTypeId\]

> `readonly` `static` **\[EffectTypeId\]**: `VarianceStruct`\<[`DialogContext`](../interfaces/DialogContext.md), `never`, `DialogCtx`\>

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Effect.d.ts:195

#### Inherited from

`Context.Tag("DialogContext")< DialogCtx, DialogContext >().[EffectTypeId]`
...
`Context.Tag("DialogContext")< DialogCtx, DialogContext >().[ignoreSymbol]`

***

### \[SinkTypeId\]

> `readonly` `static` **\[SinkTypeId\]**: `VarianceStruct`\<[`DialogContext`](../interfaces/DialogContext.md), `unknown`, `never`, `never`, `DialogCtx`\>

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Sink.d.ts:82

#### Inherited from

`Context.Tag("DialogContext")< DialogCtx, DialogContext >().[SinkTypeId]`
...
> `readonly` **\_A**: `Covariant`\<[`DialogContext`](../interfaces/DialogContext.md)\>
...
> `readonly` **\_R**: `Covariant`\<`DialogCtx`\>

#### Inherited from

`Context.Tag("DialogContext")< DialogCtx, DialogContext >().[STMTypeId]`

***

### \[StreamTypeId\]

> `readonly` `static` **\[StreamTypeId\]**: `VarianceStruct`\<[`DialogContext`](../interfaces/DialogContext.md), `never`, `DialogCtx`\>

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Stream.d.ts:111

#### Inherited from

`Context.Tag("DialogContext")< DialogCtx, DialogContext >().[StreamTypeId]`
...
> `readonly` **\_Identifier**: `Invariant`\<`DialogCtx`\>

#### \_Service

> `readonly` **\_Service**: `Invariant`\<[`DialogContext`](../interfaces/DialogContext.md)\>
...
`Context.Tag("DialogContext")< DialogCtx, DialogContext >().[typeSymbol]`

***

### \[unifySymbol\]?

> `static` `optional` **\[unifySymbol\]**: `TagUnify`\<`TagClass`\<`DialogCtx`, `"DialogContext"`, [`DialogContext`](../interfaces/DialogContext.md)\>\>

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Context.d.ts:45

#### Inherited from

`Context.Tag("DialogContext")< DialogCtx, DialogContext >().[unifySymbol]`

***

### Identifier

> `readonly` `static` **Identifier**: `DialogCtx`

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Context.d.ts:35

#### Inherited from

`Context.Tag("DialogContext")< DialogCtx, DialogContext >().Identifier`

***

### key

> `readonly` `static` **key**: `"DialogContext"`

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Context.d.ts:110

#### Inherited from

`Context.Tag("DialogContext")< DialogCtx, DialogContext >().key`

***

### Service

> `readonly` `static` **Service**: [`DialogContext`](../interfaces/DialogContext.md)

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Context.d.ts:34

#### Inherited from

`Context.Tag("DialogContext")< DialogCtx, DialogContext >().Service`
...
`Context.Tag("DialogContext")< DialogCtx, DialogContext >().stack`

## Methods

### \[iterator\]()

> `static` **\[iterator\]**(): `EffectGenerator`\<`Tag`\<`DialogCtx`, [`DialogContext`](../interfaces/DialogContext.md)\>\>

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Effect.d.ts:137

#### Returns

`EffectGenerator`\<`Tag`\<`DialogCtx`, [`DialogContext`](../interfaces/DialogContext.md)\>\>

#### Inherited from

`Context.Tag("DialogContext")< DialogCtx, DialogContext >().[iterator]`
...
`Context.Tag("DialogContext")< DialogCtx, DialogContext >().[NodeInspectSymbol]`

***

### context()

> `static` **context**(`self`): `Context`\<`DialogCtx`\>
...
`Context.Tag("DialogContext")< DialogCtx, DialogContext >().context`

***

### of()

> `static` **of**(`self`): [`DialogContext`](../interfaces/DialogContext.md)
...
`Context.Tag("DialogContext")< DialogCtx, DialogContext >().of`
...
`Context.Tag("DialogContext")< DialogCtx, DialogContext >().pipe`
...
`Context.Tag("DialogContext")< DialogCtx, DialogContext >().toJSON`
...
`Context.Tag("DialogContext")< DialogCtx, DialogContext >().toString`
