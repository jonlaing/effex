...
[effex-monorepo](../../../modules.md) / [primitives/src](../README.md) / DropdownMenuSubCtx

# Class: DropdownMenuSubCtx

Defined in: [packages/primitives/src/primitives/DropdownMenu/DropdownMenu.ts:236](https://github.com/jonlaing/effex/blob/54ecd92e6ce2cfbeee604b727471aa18d6829626/packages/primitives/src/primitives/DropdownMenu/DropdownMenu.ts#L236)

Effect Context for DropdownMenu.Sub state sharing.

## Extends

- `TagClassShape`\<`"DropdownMenuSubContext"`, [`DropdownMenuSubContext`](../interfaces/DropdownMenuSubContext.md), `this`\>

## Constructors

### Constructor

> **new DropdownMenuSubCtx**(`_`): `DropdownMenuSubCtx`
...
`Context.Tag("DropdownMenuSubContext")< DropdownMenuSubCtx, DropdownMenuSubContext >().constructor`
...
`Context.Tag("DropdownMenuSubContext")< DropdownMenuSubCtx, DropdownMenuSubContext >().[TagTypeId]`

***

### Id

> **Id**: `"DropdownMenuSubContext"`

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Context.d.ts:99

#### Inherited from

`Context.Tag("DropdownMenuSubContext")< DropdownMenuSubCtx, DropdownMenuSubContext >().Id`

***

### Type

> `readonly` **Type**: [`DropdownMenuSubContext`](../interfaces/DropdownMenuSubContext.md)

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Context.d.ts:101

#### Inherited from

`Context.Tag("DropdownMenuSubContext")< DropdownMenuSubCtx, DropdownMenuSubContext >().Type`
...
`Context.Tag("DropdownMenuSubContext")< DropdownMenuSubCtx, DropdownMenuSubContext >()._op`

***

### \[ChannelTypeId\]

> `readonly` `static` **\[ChannelTypeId\]**: `VarianceStruct`\<`never`, `unknown`, `never`, `unknown`, [`DropdownMenuSubContext`](../interfaces/DropdownMenuSubContext.md), `unknown`, `DropdownMenuSubCtx`\>

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Channel.d.ts:108

#### Inherited from

`Context.Tag("DropdownMenuSubContext")< DropdownMenuSubCtx, DropdownMenuSubContext >().[ChannelTypeId]`

***

### \[EffectTypeId\]

> `readonly` `static` **\[EffectTypeId\]**: `VarianceStruct`\<[`DropdownMenuSubContext`](../interfaces/DropdownMenuSubContext.md), `never`, `DropdownMenuSubCtx`\>

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Effect.d.ts:195

#### Inherited from

`Context.Tag("DropdownMenuSubContext")< DropdownMenuSubCtx, DropdownMenuSubContext >().[EffectTypeId]`
...
`Context.Tag("DropdownMenuSubContext")< DropdownMenuSubCtx, DropdownMenuSubContext >().[ignoreSymbol]`

***

### \[SinkTypeId\]

> `readonly` `static` **\[SinkTypeId\]**: `VarianceStruct`\<[`DropdownMenuSubContext`](../interfaces/DropdownMenuSubContext.md), `unknown`, `never`, `never`, `DropdownMenuSubCtx`\>

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Sink.d.ts:82

#### Inherited from

`Context.Tag("DropdownMenuSubContext")< DropdownMenuSubCtx, DropdownMenuSubContext >().[SinkTypeId]`
...
> `readonly` **\_A**: `Covariant`\<[`DropdownMenuSubContext`](../interfaces/DropdownMenuSubContext.md)\>
...
> `readonly` **\_R**: `Covariant`\<`DropdownMenuSubCtx`\>

#### Inherited from

`Context.Tag("DropdownMenuSubContext")< DropdownMenuSubCtx, DropdownMenuSubContext >().[STMTypeId]`

***

### \[StreamTypeId\]

> `readonly` `static` **\[StreamTypeId\]**: `VarianceStruct`\<[`DropdownMenuSubContext`](../interfaces/DropdownMenuSubContext.md), `never`, `DropdownMenuSubCtx`\>

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Stream.d.ts:111

#### Inherited from

`Context.Tag("DropdownMenuSubContext")< DropdownMenuSubCtx, DropdownMenuSubContext >().[StreamTypeId]`
...
> `readonly` **\_Identifier**: `Invariant`\<`DropdownMenuSubCtx`\>

#### \_Service

> `readonly` **\_Service**: `Invariant`\<[`DropdownMenuSubContext`](../interfaces/DropdownMenuSubContext.md)\>
...
`Context.Tag("DropdownMenuSubContext")< DropdownMenuSubCtx, DropdownMenuSubContext >().[typeSymbol]`

***

### \[unifySymbol\]?

> `static` `optional` **\[unifySymbol\]**: `TagUnify`\<`TagClass`\<`DropdownMenuSubCtx`, `"DropdownMenuSubContext"`, [`DropdownMenuSubContext`](../interfaces/DropdownMenuSubContext.md)\>\>

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Context.d.ts:45

#### Inherited from

`Context.Tag("DropdownMenuSubContext")< DropdownMenuSubCtx, DropdownMenuSubContext >().[unifySymbol]`

***

### Identifier

> `readonly` `static` **Identifier**: `DropdownMenuSubCtx`

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Context.d.ts:35

#### Inherited from

`Context.Tag("DropdownMenuSubContext")< DropdownMenuSubCtx, DropdownMenuSubContext >().Identifier`

***

### key

> `readonly` `static` **key**: `"DropdownMenuSubContext"`

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Context.d.ts:110

#### Inherited from

`Context.Tag("DropdownMenuSubContext")< DropdownMenuSubCtx, DropdownMenuSubContext >().key`

***

### Service

> `readonly` `static` **Service**: [`DropdownMenuSubContext`](../interfaces/DropdownMenuSubContext.md)

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Context.d.ts:34

#### Inherited from

`Context.Tag("DropdownMenuSubContext")< DropdownMenuSubCtx, DropdownMenuSubContext >().Service`
...
`Context.Tag("DropdownMenuSubContext")< DropdownMenuSubCtx, DropdownMenuSubContext >().stack`

## Methods

### \[iterator\]()

> `static` **\[iterator\]**(): `EffectGenerator`\<`Tag`\<`DropdownMenuSubCtx`, [`DropdownMenuSubContext`](../interfaces/DropdownMenuSubContext.md)\>\>

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Effect.d.ts:137

#### Returns

`EffectGenerator`\<`Tag`\<`DropdownMenuSubCtx`, [`DropdownMenuSubContext`](../interfaces/DropdownMenuSubContext.md)\>\>

#### Inherited from

`Context.Tag("DropdownMenuSubContext")< DropdownMenuSubCtx, DropdownMenuSubContext >().[iterator]`
...
`Context.Tag("DropdownMenuSubContext")< DropdownMenuSubCtx, DropdownMenuSubContext >().[NodeInspectSymbol]`

***

### context()

> `static` **context**(`self`): `Context`\<`DropdownMenuSubCtx`\>
...
`Context`\<`DropdownMenuSubCtx`\>

#### Inherited from

`Context.Tag("DropdownMenuSubContext")< DropdownMenuSubCtx, DropdownMenuSubContext >().context`

***

### of()

> `static` **of**(`self`): [`DropdownMenuSubContext`](../interfaces/DropdownMenuSubContext.md)
...
`Context.Tag("DropdownMenuSubContext")< DropdownMenuSubCtx, DropdownMenuSubContext >().of`
...
`Context.Tag("DropdownMenuSubContext")< DropdownMenuSubCtx, DropdownMenuSubContext >().pipe`
...
`Context.Tag("DropdownMenuSubContext")< DropdownMenuSubCtx, DropdownMenuSubContext >().toJSON`
...
`Context.Tag("DropdownMenuSubContext")< DropdownMenuSubCtx, DropdownMenuSubContext >().toString`
