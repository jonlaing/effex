...
[effex-monorepo](../../../modules.md) / [primitives/src](../README.md) / ContextMenuSubCtx

# Class: ContextMenuSubCtx

Defined in: [packages/primitives/src/primitives/ContextMenu/ContextMenu.ts:220](https://github.com/jonlaing/effex/blob/54ecd92e6ce2cfbeee604b727471aa18d6829626/packages/primitives/src/primitives/ContextMenu/ContextMenu.ts#L220)

Effect Context for ContextMenu.Sub state sharing.

## Extends

- `TagClassShape`\<`"ContextMenuSubContext"`, [`ContextMenuSubContext`](../interfaces/ContextMenuSubContext.md), `this`\>

## Constructors

### Constructor

> **new ContextMenuSubCtx**(`_`): `ContextMenuSubCtx`
...
`Context.Tag("ContextMenuSubContext")< ContextMenuSubCtx, ContextMenuSubContext >().constructor`
...
`Context.Tag("ContextMenuSubContext")< ContextMenuSubCtx, ContextMenuSubContext >().[TagTypeId]`

***

### Id

> **Id**: `"ContextMenuSubContext"`

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Context.d.ts:99

#### Inherited from

`Context.Tag("ContextMenuSubContext")< ContextMenuSubCtx, ContextMenuSubContext >().Id`

***

### Type

> `readonly` **Type**: [`ContextMenuSubContext`](../interfaces/ContextMenuSubContext.md)

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Context.d.ts:101

#### Inherited from

`Context.Tag("ContextMenuSubContext")< ContextMenuSubCtx, ContextMenuSubContext >().Type`
...
`Context.Tag("ContextMenuSubContext")< ContextMenuSubCtx, ContextMenuSubContext >()._op`

***

### \[ChannelTypeId\]

> `readonly` `static` **\[ChannelTypeId\]**: `VarianceStruct`\<`never`, `unknown`, `never`, `unknown`, [`ContextMenuSubContext`](../interfaces/ContextMenuSubContext.md), `unknown`, `ContextMenuSubCtx`\>

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Channel.d.ts:108

#### Inherited from

`Context.Tag("ContextMenuSubContext")< ContextMenuSubCtx, ContextMenuSubContext >().[ChannelTypeId]`

***

### \[EffectTypeId\]

> `readonly` `static` **\[EffectTypeId\]**: `VarianceStruct`\<[`ContextMenuSubContext`](../interfaces/ContextMenuSubContext.md), `never`, `ContextMenuSubCtx`\>

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Effect.d.ts:195

#### Inherited from

`Context.Tag("ContextMenuSubContext")< ContextMenuSubCtx, ContextMenuSubContext >().[EffectTypeId]`
...
`Context.Tag("ContextMenuSubContext")< ContextMenuSubCtx, ContextMenuSubContext >().[ignoreSymbol]`

***

### \[SinkTypeId\]

> `readonly` `static` **\[SinkTypeId\]**: `VarianceStruct`\<[`ContextMenuSubContext`](../interfaces/ContextMenuSubContext.md), `unknown`, `never`, `never`, `ContextMenuSubCtx`\>

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Sink.d.ts:82

#### Inherited from

`Context.Tag("ContextMenuSubContext")< ContextMenuSubCtx, ContextMenuSubContext >().[SinkTypeId]`
...
> `readonly` **\_A**: `Covariant`\<[`ContextMenuSubContext`](../interfaces/ContextMenuSubContext.md)\>
...
> `readonly` **\_R**: `Covariant`\<`ContextMenuSubCtx`\>

#### Inherited from

`Context.Tag("ContextMenuSubContext")< ContextMenuSubCtx, ContextMenuSubContext >().[STMTypeId]`

***

### \[StreamTypeId\]

> `readonly` `static` **\[StreamTypeId\]**: `VarianceStruct`\<[`ContextMenuSubContext`](../interfaces/ContextMenuSubContext.md), `never`, `ContextMenuSubCtx`\>

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Stream.d.ts:111

#### Inherited from

`Context.Tag("ContextMenuSubContext")< ContextMenuSubCtx, ContextMenuSubContext >().[StreamTypeId]`
...
> `readonly` **\_Identifier**: `Invariant`\<`ContextMenuSubCtx`\>

#### \_Service

> `readonly` **\_Service**: `Invariant`\<[`ContextMenuSubContext`](../interfaces/ContextMenuSubContext.md)\>
...
`Context.Tag("ContextMenuSubContext")< ContextMenuSubCtx, ContextMenuSubContext >().[typeSymbol]`

***

### \[unifySymbol\]?

> `static` `optional` **\[unifySymbol\]**: `TagUnify`\<`TagClass`\<`ContextMenuSubCtx`, `"ContextMenuSubContext"`, [`ContextMenuSubContext`](../interfaces/ContextMenuSubContext.md)\>\>

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Context.d.ts:45

#### Inherited from

`Context.Tag("ContextMenuSubContext")< ContextMenuSubCtx, ContextMenuSubContext >().[unifySymbol]`

***

### Identifier

> `readonly` `static` **Identifier**: `ContextMenuSubCtx`

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Context.d.ts:35

#### Inherited from

`Context.Tag("ContextMenuSubContext")< ContextMenuSubCtx, ContextMenuSubContext >().Identifier`

***

### key

> `readonly` `static` **key**: `"ContextMenuSubContext"`

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Context.d.ts:110

#### Inherited from

`Context.Tag("ContextMenuSubContext")< ContextMenuSubCtx, ContextMenuSubContext >().key`

***

### Service

> `readonly` `static` **Service**: [`ContextMenuSubContext`](../interfaces/ContextMenuSubContext.md)

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Context.d.ts:34

#### Inherited from

`Context.Tag("ContextMenuSubContext")< ContextMenuSubCtx, ContextMenuSubContext >().Service`
...
`Context.Tag("ContextMenuSubContext")< ContextMenuSubCtx, ContextMenuSubContext >().stack`

## Methods

### \[iterator\]()

> `static` **\[iterator\]**(): `EffectGenerator`\<`Tag`\<`ContextMenuSubCtx`, [`ContextMenuSubContext`](../interfaces/ContextMenuSubContext.md)\>\>

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Effect.d.ts:137

#### Returns

`EffectGenerator`\<`Tag`\<`ContextMenuSubCtx`, [`ContextMenuSubContext`](../interfaces/ContextMenuSubContext.md)\>\>

#### Inherited from

`Context.Tag("ContextMenuSubContext")< ContextMenuSubCtx, ContextMenuSubContext >().[iterator]`
...
`Context.Tag("ContextMenuSubContext")< ContextMenuSubCtx, ContextMenuSubContext >().[NodeInspectSymbol]`

***

### context()

> `static` **context**(`self`): `Context`\<`ContextMenuSubCtx`\>
...
`Context`\<`ContextMenuSubCtx`\>

#### Inherited from

`Context.Tag("ContextMenuSubContext")< ContextMenuSubCtx, ContextMenuSubContext >().context`

***

### of()

> `static` **of**(`self`): [`ContextMenuSubContext`](../interfaces/ContextMenuSubContext.md)
...
`Context.Tag("ContextMenuSubContext")< ContextMenuSubCtx, ContextMenuSubContext >().of`
...
`Context.Tag("ContextMenuSubContext")< ContextMenuSubCtx, ContextMenuSubContext >().pipe`
...
`Context.Tag("ContextMenuSubContext")< ContextMenuSubCtx, ContextMenuSubContext >().toJSON`
...
`Context.Tag("ContextMenuSubContext")< ContextMenuSubCtx, ContextMenuSubContext >().toString`
