...
[effex-monorepo](../../../modules.md) / [primitives/src](../README.md) / SelectItemCtx

# Class: SelectItemCtx

Defined in: [packages/primitives/src/primitives/Select/Select.ts:178](https://github.com/jonlaing/effex/blob/54ecd92e6ce2cfbeee604b727471aa18d6829626/packages/primitives/src/primitives/Select/Select.ts#L178)

Effect Context for Select.Item

## Extends

- `TagClassShape`\<`"SelectItemContext"`, [`SelectItemContext`](../interfaces/SelectItemContext.md), `this`\>

## Constructors

### Constructor

> **new SelectItemCtx**(`_`): `SelectItemCtx`
...
`Context.Tag("SelectItemContext")< SelectItemCtx, SelectItemContext >().constructor`
...
`Context.Tag("SelectItemContext")< SelectItemCtx, SelectItemContext >().[TagTypeId]`

***

### Id

> **Id**: `"SelectItemContext"`

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Context.d.ts:99

#### Inherited from

`Context.Tag("SelectItemContext")< SelectItemCtx, SelectItemContext >().Id`

***

### Type

> `readonly` **Type**: [`SelectItemContext`](../interfaces/SelectItemContext.md)

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Context.d.ts:101

#### Inherited from

`Context.Tag("SelectItemContext")< SelectItemCtx, SelectItemContext >().Type`
...
`Context.Tag("SelectItemContext")< SelectItemCtx, SelectItemContext >()._op`

***

### \[ChannelTypeId\]

> `readonly` `static` **\[ChannelTypeId\]**: `VarianceStruct`\<`never`, `unknown`, `never`, `unknown`, [`SelectItemContext`](../interfaces/SelectItemContext.md), `unknown`, `SelectItemCtx`\>

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Channel.d.ts:108

#### Inherited from

`Context.Tag("SelectItemContext")< SelectItemCtx, SelectItemContext >().[ChannelTypeId]`

***

### \[EffectTypeId\]

> `readonly` `static` **\[EffectTypeId\]**: `VarianceStruct`\<[`SelectItemContext`](../interfaces/SelectItemContext.md), `never`, `SelectItemCtx`\>

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Effect.d.ts:195

#### Inherited from

`Context.Tag("SelectItemContext")< SelectItemCtx, SelectItemContext >().[EffectTypeId]`
...
`Context.Tag("SelectItemContext")< SelectItemCtx, SelectItemContext >().[ignoreSymbol]`

***

### \[SinkTypeId\]

> `readonly` `static` **\[SinkTypeId\]**: `VarianceStruct`\<[`SelectItemContext`](../interfaces/SelectItemContext.md), `unknown`, `never`, `never`, `SelectItemCtx`\>

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Sink.d.ts:82

#### Inherited from

`Context.Tag("SelectItemContext")< SelectItemCtx, SelectItemContext >().[SinkTypeId]`
...
> `readonly` **\_A**: `Covariant`\<[`SelectItemContext`](../interfaces/SelectItemContext.md)\>
...
> `readonly` **\_R**: `Covariant`\<`SelectItemCtx`\>

#### Inherited from

`Context.Tag("SelectItemContext")< SelectItemCtx, SelectItemContext >().[STMTypeId]`

***

### \[StreamTypeId\]

> `readonly` `static` **\[StreamTypeId\]**: `VarianceStruct`\<[`SelectItemContext`](../interfaces/SelectItemContext.md), `never`, `SelectItemCtx`\>

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Stream.d.ts:111

#### Inherited from

`Context.Tag("SelectItemContext")< SelectItemCtx, SelectItemContext >().[StreamTypeId]`
...
> `readonly` **\_Identifier**: `Invariant`\<`SelectItemCtx`\>

#### \_Service

> `readonly` **\_Service**: `Invariant`\<[`SelectItemContext`](../interfaces/SelectItemContext.md)\>
...
`Context.Tag("SelectItemContext")< SelectItemCtx, SelectItemContext >().[typeSymbol]`

***

### \[unifySymbol\]?

> `static` `optional` **\[unifySymbol\]**: `TagUnify`\<`TagClass`\<`SelectItemCtx`, `"SelectItemContext"`, [`SelectItemContext`](../interfaces/SelectItemContext.md)\>\>

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Context.d.ts:45

#### Inherited from

`Context.Tag("SelectItemContext")< SelectItemCtx, SelectItemContext >().[unifySymbol]`

***

### Identifier

> `readonly` `static` **Identifier**: `SelectItemCtx`

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Context.d.ts:35

#### Inherited from

`Context.Tag("SelectItemContext")< SelectItemCtx, SelectItemContext >().Identifier`

***

### key

> `readonly` `static` **key**: `"SelectItemContext"`

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Context.d.ts:110

#### Inherited from

`Context.Tag("SelectItemContext")< SelectItemCtx, SelectItemContext >().key`

***

### Service

> `readonly` `static` **Service**: [`SelectItemContext`](../interfaces/SelectItemContext.md)

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Context.d.ts:34

#### Inherited from

`Context.Tag("SelectItemContext")< SelectItemCtx, SelectItemContext >().Service`
...
`Context.Tag("SelectItemContext")< SelectItemCtx, SelectItemContext >().stack`

## Methods

### \[iterator\]()

> `static` **\[iterator\]**(): `EffectGenerator`\<`Tag`\<`SelectItemCtx`, [`SelectItemContext`](../interfaces/SelectItemContext.md)\>\>

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Effect.d.ts:137

#### Returns

`EffectGenerator`\<`Tag`\<`SelectItemCtx`, [`SelectItemContext`](../interfaces/SelectItemContext.md)\>\>

#### Inherited from

`Context.Tag("SelectItemContext")< SelectItemCtx, SelectItemContext >().[iterator]`
...
`Context.Tag("SelectItemContext")< SelectItemCtx, SelectItemContext >().[NodeInspectSymbol]`

***

### context()

> `static` **context**(`self`): `Context`\<`SelectItemCtx`\>
...
`Context`\<`SelectItemCtx`\>

#### Inherited from

`Context.Tag("SelectItemContext")< SelectItemCtx, SelectItemContext >().context`

***

### of()

> `static` **of**(`self`): [`SelectItemContext`](../interfaces/SelectItemContext.md)
...
`Context.Tag("SelectItemContext")< SelectItemCtx, SelectItemContext >().of`
...
`Context.Tag("SelectItemContext")< SelectItemCtx, SelectItemContext >().pipe`
...
`Context.Tag("SelectItemContext")< SelectItemCtx, SelectItemContext >().toJSON`
...
`Context.Tag("SelectItemContext")< SelectItemCtx, SelectItemContext >().toString`
