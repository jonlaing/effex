...
[effex-monorepo](../../../modules.md) / [primitives/src](../README.md) / DropdownMenuCtx

# Class: DropdownMenuCtx

Defined in: [packages/primitives/src/primitives/DropdownMenu/DropdownMenu.ts:228](https://github.com/jonlaing/effex/blob/54ecd92e6ce2cfbeee604b727471aa18d6829626/packages/primitives/src/primitives/DropdownMenu/DropdownMenu.ts#L228)

Effect Context for DropdownMenu state sharing between parts.

## Extends

- `TagClassShape`\<`"DropdownMenuContext"`, [`DropdownMenuContext`](../interfaces/DropdownMenuContext.md), `this`\>

## Constructors

### Constructor

> **new DropdownMenuCtx**(`_`): `DropdownMenuCtx`
...
`Context.Tag("DropdownMenuContext")< DropdownMenuCtx, DropdownMenuContext >().constructor`
...
`Context.Tag("DropdownMenuContext")< DropdownMenuCtx, DropdownMenuContext >().[TagTypeId]`
...
`Context.Tag("DropdownMenuContext")< DropdownMenuCtx, DropdownMenuContext >().Id`

***

### Type

> `readonly` **Type**: [`DropdownMenuContext`](../interfaces/DropdownMenuContext.md)

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Context.d.ts:101

#### Inherited from

`Context.Tag("DropdownMenuContext")< DropdownMenuCtx, DropdownMenuContext >().Type`
...
`Context.Tag("DropdownMenuContext")< DropdownMenuCtx, DropdownMenuContext >()._op`

***

### \[ChannelTypeId\]

> `readonly` `static` **\[ChannelTypeId\]**: `VarianceStruct`\<`never`, `unknown`, `never`, `unknown`, [`DropdownMenuContext`](../interfaces/DropdownMenuContext.md), `unknown`, `DropdownMenuCtx`\>

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Channel.d.ts:108

#### Inherited from

`Context.Tag("DropdownMenuContext")< DropdownMenuCtx, DropdownMenuContext >().[ChannelTypeId]`

***

### \[EffectTypeId\]

> `readonly` `static` **\[EffectTypeId\]**: `VarianceStruct`\<[`DropdownMenuContext`](../interfaces/DropdownMenuContext.md), `never`, `DropdownMenuCtx`\>

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Effect.d.ts:195

#### Inherited from

`Context.Tag("DropdownMenuContext")< DropdownMenuCtx, DropdownMenuContext >().[EffectTypeId]`
...
`Context.Tag("DropdownMenuContext")< DropdownMenuCtx, DropdownMenuContext >().[ignoreSymbol]`

***

### \[SinkTypeId\]

> `readonly` `static` **\[SinkTypeId\]**: `VarianceStruct`\<[`DropdownMenuContext`](../interfaces/DropdownMenuContext.md), `unknown`, `never`, `never`, `DropdownMenuCtx`\>

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Sink.d.ts:82

#### Inherited from

`Context.Tag("DropdownMenuContext")< DropdownMenuCtx, DropdownMenuContext >().[SinkTypeId]`
...
> `readonly` **\_A**: `Covariant`\<[`DropdownMenuContext`](../interfaces/DropdownMenuContext.md)\>
...
> `readonly` **\_R**: `Covariant`\<`DropdownMenuCtx`\>

#### Inherited from

`Context.Tag("DropdownMenuContext")< DropdownMenuCtx, DropdownMenuContext >().[STMTypeId]`

***

### \[StreamTypeId\]

> `readonly` `static` **\[StreamTypeId\]**: `VarianceStruct`\<[`DropdownMenuContext`](../interfaces/DropdownMenuContext.md), `never`, `DropdownMenuCtx`\>

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Stream.d.ts:111

#### Inherited from

`Context.Tag("DropdownMenuContext")< DropdownMenuCtx, DropdownMenuContext >().[StreamTypeId]`
...
> `readonly` **\_Identifier**: `Invariant`\<`DropdownMenuCtx`\>

#### \_Service

> `readonly` **\_Service**: `Invariant`\<[`DropdownMenuContext`](../interfaces/DropdownMenuContext.md)\>
...
`Context.Tag("DropdownMenuContext")< DropdownMenuCtx, DropdownMenuContext >().[typeSymbol]`

***

### \[unifySymbol\]?

> `static` `optional` **\[unifySymbol\]**: `TagUnify`\<`TagClass`\<`DropdownMenuCtx`, `"DropdownMenuContext"`, [`DropdownMenuContext`](../interfaces/DropdownMenuContext.md)\>\>

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Context.d.ts:45

#### Inherited from

`Context.Tag("DropdownMenuContext")< DropdownMenuCtx, DropdownMenuContext >().[unifySymbol]`

***

### Identifier

> `readonly` `static` **Identifier**: `DropdownMenuCtx`

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Context.d.ts:35

#### Inherited from

`Context.Tag("DropdownMenuContext")< DropdownMenuCtx, DropdownMenuContext >().Identifier`

***

### key

> `readonly` `static` **key**: `"DropdownMenuContext"`

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Context.d.ts:110

#### Inherited from

`Context.Tag("DropdownMenuContext")< DropdownMenuCtx, DropdownMenuContext >().key`

***

### Service

> `readonly` `static` **Service**: [`DropdownMenuContext`](../interfaces/DropdownMenuContext.md)

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Context.d.ts:34

#### Inherited from

`Context.Tag("DropdownMenuContext")< DropdownMenuCtx, DropdownMenuContext >().Service`
...
`Context.Tag("DropdownMenuContext")< DropdownMenuCtx, DropdownMenuContext >().stack`

## Methods

### \[iterator\]()

> `static` **\[iterator\]**(): `EffectGenerator`\<`Tag`\<`DropdownMenuCtx`, [`DropdownMenuContext`](../interfaces/DropdownMenuContext.md)\>\>

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Effect.d.ts:137

#### Returns

`EffectGenerator`\<`Tag`\<`DropdownMenuCtx`, [`DropdownMenuContext`](../interfaces/DropdownMenuContext.md)\>\>

#### Inherited from

`Context.Tag("DropdownMenuContext")< DropdownMenuCtx, DropdownMenuContext >().[iterator]`
...
`Context.Tag("DropdownMenuContext")< DropdownMenuCtx, DropdownMenuContext >().[NodeInspectSymbol]`

***

### context()

> `static` **context**(`self`): `Context`\<`DropdownMenuCtx`\>
...
`Context`\<`DropdownMenuCtx`\>

#### Inherited from

`Context.Tag("DropdownMenuContext")< DropdownMenuCtx, DropdownMenuContext >().context`

***

### of()

> `static` **of**(`self`): [`DropdownMenuContext`](../interfaces/DropdownMenuContext.md)
...
`Context.Tag("DropdownMenuContext")< DropdownMenuCtx, DropdownMenuContext >().of`
...
`Context.Tag("DropdownMenuContext")< DropdownMenuCtx, DropdownMenuContext >().pipe`
...
`Context.Tag("DropdownMenuContext")< DropdownMenuCtx, DropdownMenuContext >().toJSON`
...
`Context.Tag("DropdownMenuContext")< DropdownMenuCtx, DropdownMenuContext >().toString`
