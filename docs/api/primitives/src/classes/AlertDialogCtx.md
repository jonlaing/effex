...
[effex-monorepo](../../../modules.md) / [primitives/src](../README.md) / AlertDialogCtx

# Class: AlertDialogCtx

Defined in: [packages/primitives/src/primitives/AlertDialog/AlertDialog.ts:120](https://github.com/jonlaing/effex/blob/6a1b9c8b38e226609ce7e1a1f5173769b8aad981/packages/primitives/src/primitives/AlertDialog/AlertDialog.ts#L120)

Effect Context for AlertDialog state sharing between parts.

## Extends

- `TagClassShape`\<`"AlertDialogContext"`, [`AlertDialogContext`](../interfaces/AlertDialogContext.md), `this`\>

## Constructors

### Constructor

> **new AlertDialogCtx**(`_`): `AlertDialogCtx`
...
`Context.Tag("AlertDialogContext")< AlertDialogCtx, AlertDialogContext >().constructor`
...
`Context.Tag("AlertDialogContext")< AlertDialogCtx, AlertDialogContext >().[TagTypeId]`

***

### Id

> **Id**: `"AlertDialogContext"`

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Context.d.ts:99

#### Inherited from

`Context.Tag("AlertDialogContext")< AlertDialogCtx, AlertDialogContext >().Id`

***

### Type

> `readonly` **Type**: [`AlertDialogContext`](../interfaces/AlertDialogContext.md)

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Context.d.ts:101

#### Inherited from

`Context.Tag("AlertDialogContext")< AlertDialogCtx, AlertDialogContext >().Type`
...
`Context.Tag("AlertDialogContext")< AlertDialogCtx, AlertDialogContext >()._op`

***

### \[ChannelTypeId\]

> `readonly` `static` **\[ChannelTypeId\]**: `VarianceStruct`\<`never`, `unknown`, `never`, `unknown`, [`AlertDialogContext`](../interfaces/AlertDialogContext.md), `unknown`, `AlertDialogCtx`\>

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Channel.d.ts:108

#### Inherited from

`Context.Tag("AlertDialogContext")< AlertDialogCtx, AlertDialogContext >().[ChannelTypeId]`

***

### \[EffectTypeId\]

> `readonly` `static` **\[EffectTypeId\]**: `VarianceStruct`\<[`AlertDialogContext`](../interfaces/AlertDialogContext.md), `never`, `AlertDialogCtx`\>

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Effect.d.ts:195

#### Inherited from

`Context.Tag("AlertDialogContext")< AlertDialogCtx, AlertDialogContext >().[EffectTypeId]`
...
`Context.Tag("AlertDialogContext")< AlertDialogCtx, AlertDialogContext >().[ignoreSymbol]`

***

### \[SinkTypeId\]

> `readonly` `static` **\[SinkTypeId\]**: `VarianceStruct`\<[`AlertDialogContext`](../interfaces/AlertDialogContext.md), `unknown`, `never`, `never`, `AlertDialogCtx`\>

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Sink.d.ts:82

#### Inherited from

`Context.Tag("AlertDialogContext")< AlertDialogCtx, AlertDialogContext >().[SinkTypeId]`
...
> `readonly` **\_A**: `Covariant`\<[`AlertDialogContext`](../interfaces/AlertDialogContext.md)\>
...
> `readonly` **\_R**: `Covariant`\<`AlertDialogCtx`\>

#### Inherited from

`Context.Tag("AlertDialogContext")< AlertDialogCtx, AlertDialogContext >().[STMTypeId]`

***

### \[StreamTypeId\]

> `readonly` `static` **\[StreamTypeId\]**: `VarianceStruct`\<[`AlertDialogContext`](../interfaces/AlertDialogContext.md), `never`, `AlertDialogCtx`\>

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Stream.d.ts:111

#### Inherited from

`Context.Tag("AlertDialogContext")< AlertDialogCtx, AlertDialogContext >().[StreamTypeId]`
...
> `readonly` **\_Identifier**: `Invariant`\<`AlertDialogCtx`\>

#### \_Service

> `readonly` **\_Service**: `Invariant`\<[`AlertDialogContext`](../interfaces/AlertDialogContext.md)\>
...
`Context.Tag("AlertDialogContext")< AlertDialogCtx, AlertDialogContext >().[typeSymbol]`

***

### \[unifySymbol\]?

> `static` `optional` **\[unifySymbol\]**: `TagUnify`\<`TagClass`\<`AlertDialogCtx`, `"AlertDialogContext"`, [`AlertDialogContext`](../interfaces/AlertDialogContext.md)\>\>

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Context.d.ts:45

#### Inherited from

`Context.Tag("AlertDialogContext")< AlertDialogCtx, AlertDialogContext >().[unifySymbol]`

***

### Identifier

> `readonly` `static` **Identifier**: `AlertDialogCtx`

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Context.d.ts:35

#### Inherited from

`Context.Tag("AlertDialogContext")< AlertDialogCtx, AlertDialogContext >().Identifier`

***

### key

> `readonly` `static` **key**: `"AlertDialogContext"`

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Context.d.ts:110

#### Inherited from

`Context.Tag("AlertDialogContext")< AlertDialogCtx, AlertDialogContext >().key`

***

### Service

> `readonly` `static` **Service**: [`AlertDialogContext`](../interfaces/AlertDialogContext.md)

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Context.d.ts:34

#### Inherited from

`Context.Tag("AlertDialogContext")< AlertDialogCtx, AlertDialogContext >().Service`
...
`Context.Tag("AlertDialogContext")< AlertDialogCtx, AlertDialogContext >().stack`

## Methods

### \[iterator\]()

> `static` **\[iterator\]**(): `EffectGenerator`\<`Tag`\<`AlertDialogCtx`, [`AlertDialogContext`](../interfaces/AlertDialogContext.md)\>\>

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Effect.d.ts:137

#### Returns

`EffectGenerator`\<`Tag`\<`AlertDialogCtx`, [`AlertDialogContext`](../interfaces/AlertDialogContext.md)\>\>

#### Inherited from

`Context.Tag("AlertDialogContext")< AlertDialogCtx, AlertDialogContext >().[iterator]`
...
`Context.Tag("AlertDialogContext")< AlertDialogCtx, AlertDialogContext >().[NodeInspectSymbol]`

***

### context()

> `static` **context**(`self`): `Context`\<`AlertDialogCtx`\>
...
`Context`\<`AlertDialogCtx`\>

#### Inherited from

`Context.Tag("AlertDialogContext")< AlertDialogCtx, AlertDialogContext >().context`

***

### of()

> `static` **of**(`self`): [`AlertDialogContext`](../interfaces/AlertDialogContext.md)
...
`Context.Tag("AlertDialogContext")< AlertDialogCtx, AlertDialogContext >().of`
...
`Context.Tag("AlertDialogContext")< AlertDialogCtx, AlertDialogContext >().pipe`
...
`Context.Tag("AlertDialogContext")< AlertDialogCtx, AlertDialogContext >().toJSON`
...
`Context.Tag("AlertDialogContext")< AlertDialogCtx, AlertDialogContext >().toString`
