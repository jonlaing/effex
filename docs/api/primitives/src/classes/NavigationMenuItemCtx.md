...
[effex-monorepo](../../../modules.md) / [primitives/src](../README.md) / NavigationMenuItemCtx

# Class: NavigationMenuItemCtx

Defined in: [packages/primitives/src/primitives/NavigationMenu/NavigationMenu.ts:69](https://github.com/jonlaing/effex/blob/6a1b9c8b38e226609ce7e1a1f5173769b8aad981/packages/primitives/src/primitives/NavigationMenu/NavigationMenu.ts#L69)

## Extends

- `TagClassShape`\<`"NavigationMenuItemContext"`, [`NavigationMenuItemContext`](../interfaces/NavigationMenuItemContext.md), `this`\>

## Constructors

### Constructor

> **new NavigationMenuItemCtx**(`_`): `NavigationMenuItemCtx`
...
`Context.Tag( "NavigationMenuItemContext", )<NavigationMenuItemCtx, NavigationMenuItemContext>().constructor`
...
`Context.Tag( "NavigationMenuItemContext", )<NavigationMenuItemCtx, NavigationMenuItemContext>().[TagTypeId]`

***

### Id

> **Id**: `"NavigationMenuItemContext"`

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Context.d.ts:99

#### Inherited from

`Context.Tag( "NavigationMenuItemContext", )<NavigationMenuItemCtx, NavigationMenuItemContext>().Id`

***

### Type

> `readonly` **Type**: [`NavigationMenuItemContext`](../interfaces/NavigationMenuItemContext.md)

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Context.d.ts:101

#### Inherited from

`Context.Tag( "NavigationMenuItemContext", )<NavigationMenuItemCtx, NavigationMenuItemContext>().Type`
...
`Context.Tag( "NavigationMenuItemContext", )<NavigationMenuItemCtx, NavigationMenuItemContext>()._op`

***

### \[ChannelTypeId\]

> `readonly` `static` **\[ChannelTypeId\]**: `VarianceStruct`\<`never`, `unknown`, `never`, `unknown`, [`NavigationMenuItemContext`](../interfaces/NavigationMenuItemContext.md), `unknown`, `NavigationMenuItemCtx`\>

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Channel.d.ts:108

#### Inherited from

`Context.Tag( "NavigationMenuItemContext", )<NavigationMenuItemCtx, NavigationMenuItemContext>().[ChannelTypeId]`

***

### \[EffectTypeId\]

> `readonly` `static` **\[EffectTypeId\]**: `VarianceStruct`\<[`NavigationMenuItemContext`](../interfaces/NavigationMenuItemContext.md), `never`, `NavigationMenuItemCtx`\>

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Effect.d.ts:195

#### Inherited from

`Context.Tag( "NavigationMenuItemContext", )<NavigationMenuItemCtx, NavigationMenuItemContext>().[EffectTypeId]`
...
`Context.Tag( "NavigationMenuItemContext", )<NavigationMenuItemCtx, NavigationMenuItemContext>().[ignoreSymbol]`

***

### \[SinkTypeId\]

> `readonly` `static` **\[SinkTypeId\]**: `VarianceStruct`\<[`NavigationMenuItemContext`](../interfaces/NavigationMenuItemContext.md), `unknown`, `never`, `never`, `NavigationMenuItemCtx`\>

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Sink.d.ts:82

#### Inherited from

`Context.Tag( "NavigationMenuItemContext", )<NavigationMenuItemCtx, NavigationMenuItemContext>().[SinkTypeId]`
...
> `readonly` **\_A**: `Covariant`\<[`NavigationMenuItemContext`](../interfaces/NavigationMenuItemContext.md)\>
...
> `readonly` **\_R**: `Covariant`\<`NavigationMenuItemCtx`\>

#### Inherited from

`Context.Tag( "NavigationMenuItemContext", )<NavigationMenuItemCtx, NavigationMenuItemContext>().[STMTypeId]`

***

### \[StreamTypeId\]

> `readonly` `static` **\[StreamTypeId\]**: `VarianceStruct`\<[`NavigationMenuItemContext`](../interfaces/NavigationMenuItemContext.md), `never`, `NavigationMenuItemCtx`\>

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Stream.d.ts:111

#### Inherited from

`Context.Tag( "NavigationMenuItemContext", )<NavigationMenuItemCtx, NavigationMenuItemContext>().[StreamTypeId]`
...
> `readonly` **\_Identifier**: `Invariant`\<`NavigationMenuItemCtx`\>

#### \_Service

> `readonly` **\_Service**: `Invariant`\<[`NavigationMenuItemContext`](../interfaces/NavigationMenuItemContext.md)\>
...
`Context.Tag( "NavigationMenuItemContext", )<NavigationMenuItemCtx, NavigationMenuItemContext>().[typeSymbol]`

***

### \[unifySymbol\]?

> `static` `optional` **\[unifySymbol\]**: `TagUnify`\<`TagClass`\<`NavigationMenuItemCtx`, `"NavigationMenuItemContext"`, [`NavigationMenuItemContext`](../interfaces/NavigationMenuItemContext.md)\>\>

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Context.d.ts:45

#### Inherited from

`Context.Tag( "NavigationMenuItemContext", )<NavigationMenuItemCtx, NavigationMenuItemContext>().[unifySymbol]`

***

### Identifier

> `readonly` `static` **Identifier**: `NavigationMenuItemCtx`

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Context.d.ts:35

#### Inherited from

`Context.Tag( "NavigationMenuItemContext", )<NavigationMenuItemCtx, NavigationMenuItemContext>().Identifier`

***

### key

> `readonly` `static` **key**: `"NavigationMenuItemContext"`

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Context.d.ts:110

#### Inherited from

`Context.Tag( "NavigationMenuItemContext", )<NavigationMenuItemCtx, NavigationMenuItemContext>().key`

***

### Service

> `readonly` `static` **Service**: [`NavigationMenuItemContext`](../interfaces/NavigationMenuItemContext.md)

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Context.d.ts:34

#### Inherited from

`Context.Tag( "NavigationMenuItemContext", )<NavigationMenuItemCtx, NavigationMenuItemContext>().Service`
...
`Context.Tag( "NavigationMenuItemContext", )<NavigationMenuItemCtx, NavigationMenuItemContext>().stack`

## Methods

### \[iterator\]()

> `static` **\[iterator\]**(): `EffectGenerator`\<`Tag`\<`NavigationMenuItemCtx`, [`NavigationMenuItemContext`](../interfaces/NavigationMenuItemContext.md)\>\>

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Effect.d.ts:137

#### Returns

`EffectGenerator`\<`Tag`\<`NavigationMenuItemCtx`, [`NavigationMenuItemContext`](../interfaces/NavigationMenuItemContext.md)\>\>

#### Inherited from

`Context.Tag( "NavigationMenuItemContext", )<NavigationMenuItemCtx, NavigationMenuItemContext>().[iterator]`
...
`Context.Tag( "NavigationMenuItemContext", )<NavigationMenuItemCtx, NavigationMenuItemContext>().[NodeInspectSymbol]`

***

### context()

> `static` **context**(`self`): `Context`\<`NavigationMenuItemCtx`\>
...
`Context`\<`NavigationMenuItemCtx`\>

#### Inherited from

`Context.Tag( "NavigationMenuItemContext", )<NavigationMenuItemCtx, NavigationMenuItemContext>().context`

***

### of()

> `static` **of**(`self`): [`NavigationMenuItemContext`](../interfaces/NavigationMenuItemContext.md)
...
`Context.Tag( "NavigationMenuItemContext", )<NavigationMenuItemCtx, NavigationMenuItemContext>().of`
...
`Context.Tag( "NavigationMenuItemContext", )<NavigationMenuItemCtx, NavigationMenuItemContext>().pipe`
...
`Context.Tag( "NavigationMenuItemContext", )<NavigationMenuItemCtx, NavigationMenuItemContext>().toJSON`
...
`Context.Tag( "NavigationMenuItemContext", )<NavigationMenuItemCtx, NavigationMenuItemContext>().toString`
