...
[effex-monorepo](../../../modules.md) / [primitives/src](../README.md) / RadioGroupCtx

# Class: RadioGroupCtx

Defined in: [packages/primitives/src/primitives/RadioGroup/RadioGroup.ts:71](https://github.com/jonlaing/effex/blob/54ecd92e6ce2cfbeee604b727471aa18d6829626/packages/primitives/src/primitives/RadioGroup/RadioGroup.ts#L71)

Effect Context for RadioGroup state sharing between parts.

## Extends

- `TagClassShape`\<`"RadioGroupContext"`, [`RadioGroupContext`](../interfaces/RadioGroupContext.md), `this`\>

## Constructors

### Constructor

> **new RadioGroupCtx**(`_`): `RadioGroupCtx`
...
`Context.Tag("RadioGroupContext")< RadioGroupCtx, RadioGroupContext >().constructor`
...
`Context.Tag("RadioGroupContext")< RadioGroupCtx, RadioGroupContext >().[TagTypeId]`

***

### Id

> **Id**: `"RadioGroupContext"`

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Context.d.ts:99

#### Inherited from

`Context.Tag("RadioGroupContext")< RadioGroupCtx, RadioGroupContext >().Id`

***

### Type

> `readonly` **Type**: [`RadioGroupContext`](../interfaces/RadioGroupContext.md)

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Context.d.ts:101

#### Inherited from

`Context.Tag("RadioGroupContext")< RadioGroupCtx, RadioGroupContext >().Type`
...
`Context.Tag("RadioGroupContext")< RadioGroupCtx, RadioGroupContext >()._op`

***

### \[ChannelTypeId\]

> `readonly` `static` **\[ChannelTypeId\]**: `VarianceStruct`\<`never`, `unknown`, `never`, `unknown`, [`RadioGroupContext`](../interfaces/RadioGroupContext.md), `unknown`, `RadioGroupCtx`\>

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Channel.d.ts:108

#### Inherited from

`Context.Tag("RadioGroupContext")< RadioGroupCtx, RadioGroupContext >().[ChannelTypeId]`

***

### \[EffectTypeId\]

> `readonly` `static` **\[EffectTypeId\]**: `VarianceStruct`\<[`RadioGroupContext`](../interfaces/RadioGroupContext.md), `never`, `RadioGroupCtx`\>

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Effect.d.ts:195

#### Inherited from

`Context.Tag("RadioGroupContext")< RadioGroupCtx, RadioGroupContext >().[EffectTypeId]`
...
`Context.Tag("RadioGroupContext")< RadioGroupCtx, RadioGroupContext >().[ignoreSymbol]`

***

### \[SinkTypeId\]

> `readonly` `static` **\[SinkTypeId\]**: `VarianceStruct`\<[`RadioGroupContext`](../interfaces/RadioGroupContext.md), `unknown`, `never`, `never`, `RadioGroupCtx`\>

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Sink.d.ts:82

#### Inherited from

`Context.Tag("RadioGroupContext")< RadioGroupCtx, RadioGroupContext >().[SinkTypeId]`
...
> `readonly` **\_A**: `Covariant`\<[`RadioGroupContext`](../interfaces/RadioGroupContext.md)\>
...
> `readonly` **\_R**: `Covariant`\<`RadioGroupCtx`\>

#### Inherited from

`Context.Tag("RadioGroupContext")< RadioGroupCtx, RadioGroupContext >().[STMTypeId]`

***

### \[StreamTypeId\]

> `readonly` `static` **\[StreamTypeId\]**: `VarianceStruct`\<[`RadioGroupContext`](../interfaces/RadioGroupContext.md), `never`, `RadioGroupCtx`\>

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Stream.d.ts:111

#### Inherited from

`Context.Tag("RadioGroupContext")< RadioGroupCtx, RadioGroupContext >().[StreamTypeId]`
...
> `readonly` **\_Identifier**: `Invariant`\<`RadioGroupCtx`\>

#### \_Service

> `readonly` **\_Service**: `Invariant`\<[`RadioGroupContext`](../interfaces/RadioGroupContext.md)\>
...
`Context.Tag("RadioGroupContext")< RadioGroupCtx, RadioGroupContext >().[typeSymbol]`

***

### \[unifySymbol\]?

> `static` `optional` **\[unifySymbol\]**: `TagUnify`\<`TagClass`\<`RadioGroupCtx`, `"RadioGroupContext"`, [`RadioGroupContext`](../interfaces/RadioGroupContext.md)\>\>

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Context.d.ts:45

#### Inherited from

`Context.Tag("RadioGroupContext")< RadioGroupCtx, RadioGroupContext >().[unifySymbol]`

***

### Identifier

> `readonly` `static` **Identifier**: `RadioGroupCtx`

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Context.d.ts:35

#### Inherited from

`Context.Tag("RadioGroupContext")< RadioGroupCtx, RadioGroupContext >().Identifier`

***

### key

> `readonly` `static` **key**: `"RadioGroupContext"`

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Context.d.ts:110

#### Inherited from

`Context.Tag("RadioGroupContext")< RadioGroupCtx, RadioGroupContext >().key`

***

### Service

> `readonly` `static` **Service**: [`RadioGroupContext`](../interfaces/RadioGroupContext.md)

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Context.d.ts:34

#### Inherited from

`Context.Tag("RadioGroupContext")< RadioGroupCtx, RadioGroupContext >().Service`
...
`Context.Tag("RadioGroupContext")< RadioGroupCtx, RadioGroupContext >().stack`

## Methods

### \[iterator\]()

> `static` **\[iterator\]**(): `EffectGenerator`\<`Tag`\<`RadioGroupCtx`, [`RadioGroupContext`](../interfaces/RadioGroupContext.md)\>\>

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Effect.d.ts:137

#### Returns

`EffectGenerator`\<`Tag`\<`RadioGroupCtx`, [`RadioGroupContext`](../interfaces/RadioGroupContext.md)\>\>

#### Inherited from

`Context.Tag("RadioGroupContext")< RadioGroupCtx, RadioGroupContext >().[iterator]`
...
`Context.Tag("RadioGroupContext")< RadioGroupCtx, RadioGroupContext >().[NodeInspectSymbol]`

***

### context()

> `static` **context**(`self`): `Context`\<`RadioGroupCtx`\>
...
`Context.Tag("RadioGroupContext")< RadioGroupCtx, RadioGroupContext >().context`

***

### of()

> `static` **of**(`self`): [`RadioGroupContext`](../interfaces/RadioGroupContext.md)
...
`Context.Tag("RadioGroupContext")< RadioGroupCtx, RadioGroupContext >().of`
...
`Context.Tag("RadioGroupContext")< RadioGroupCtx, RadioGroupContext >().pipe`
...
`Context.Tag("RadioGroupContext")< RadioGroupCtx, RadioGroupContext >().toJSON`
...
`Context.Tag("RadioGroupContext")< RadioGroupCtx, RadioGroupContext >().toString`
