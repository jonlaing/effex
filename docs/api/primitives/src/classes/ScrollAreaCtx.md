...
[effex-monorepo](../../../modules.md) / [primitives/src](../README.md) / ScrollAreaCtx

# Class: ScrollAreaCtx

Defined in: [packages/primitives/src/primitives/ScrollArea/ScrollArea.ts:80](https://github.com/jonlaing/effex/blob/6a1b9c8b38e226609ce7e1a1f5173769b8aad981/packages/primitives/src/primitives/ScrollArea/ScrollArea.ts#L80)

## Extends

- `TagClassShape`\<`"ScrollAreaContext"`, [`ScrollAreaContext`](../interfaces/ScrollAreaContext.md), `this`\>

## Constructors

### Constructor

> **new ScrollAreaCtx**(`_`): `ScrollAreaCtx`
...
`Context.Tag("ScrollAreaContext")< ScrollAreaCtx, ScrollAreaContext >().constructor`
...
`Context.Tag("ScrollAreaContext")< ScrollAreaCtx, ScrollAreaContext >().[TagTypeId]`

***

### Id

> **Id**: `"ScrollAreaContext"`

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Context.d.ts:99

#### Inherited from

`Context.Tag("ScrollAreaContext")< ScrollAreaCtx, ScrollAreaContext >().Id`

***

### Type

> `readonly` **Type**: [`ScrollAreaContext`](../interfaces/ScrollAreaContext.md)

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Context.d.ts:101

#### Inherited from

`Context.Tag("ScrollAreaContext")< ScrollAreaCtx, ScrollAreaContext >().Type`
...
`Context.Tag("ScrollAreaContext")< ScrollAreaCtx, ScrollAreaContext >()._op`

***

### \[ChannelTypeId\]

> `readonly` `static` **\[ChannelTypeId\]**: `VarianceStruct`\<`never`, `unknown`, `never`, `unknown`, [`ScrollAreaContext`](../interfaces/ScrollAreaContext.md), `unknown`, `ScrollAreaCtx`\>

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Channel.d.ts:108

#### Inherited from

`Context.Tag("ScrollAreaContext")< ScrollAreaCtx, ScrollAreaContext >().[ChannelTypeId]`

***

### \[EffectTypeId\]

> `readonly` `static` **\[EffectTypeId\]**: `VarianceStruct`\<[`ScrollAreaContext`](../interfaces/ScrollAreaContext.md), `never`, `ScrollAreaCtx`\>

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Effect.d.ts:195

#### Inherited from

`Context.Tag("ScrollAreaContext")< ScrollAreaCtx, ScrollAreaContext >().[EffectTypeId]`
...
`Context.Tag("ScrollAreaContext")< ScrollAreaCtx, ScrollAreaContext >().[ignoreSymbol]`

***

### \[SinkTypeId\]

> `readonly` `static` **\[SinkTypeId\]**: `VarianceStruct`\<[`ScrollAreaContext`](../interfaces/ScrollAreaContext.md), `unknown`, `never`, `never`, `ScrollAreaCtx`\>

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Sink.d.ts:82

#### Inherited from

`Context.Tag("ScrollAreaContext")< ScrollAreaCtx, ScrollAreaContext >().[SinkTypeId]`
...
> `readonly` **\_A**: `Covariant`\<[`ScrollAreaContext`](../interfaces/ScrollAreaContext.md)\>
...
> `readonly` **\_R**: `Covariant`\<`ScrollAreaCtx`\>

#### Inherited from

`Context.Tag("ScrollAreaContext")< ScrollAreaCtx, ScrollAreaContext >().[STMTypeId]`

***

### \[StreamTypeId\]

> `readonly` `static` **\[StreamTypeId\]**: `VarianceStruct`\<[`ScrollAreaContext`](../interfaces/ScrollAreaContext.md), `never`, `ScrollAreaCtx`\>

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Stream.d.ts:111

#### Inherited from

`Context.Tag("ScrollAreaContext")< ScrollAreaCtx, ScrollAreaContext >().[StreamTypeId]`
...
> `readonly` **\_Identifier**: `Invariant`\<`ScrollAreaCtx`\>

#### \_Service

> `readonly` **\_Service**: `Invariant`\<[`ScrollAreaContext`](../interfaces/ScrollAreaContext.md)\>
...
`Context.Tag("ScrollAreaContext")< ScrollAreaCtx, ScrollAreaContext >().[typeSymbol]`

***

### \[unifySymbol\]?

> `static` `optional` **\[unifySymbol\]**: `TagUnify`\<`TagClass`\<`ScrollAreaCtx`, `"ScrollAreaContext"`, [`ScrollAreaContext`](../interfaces/ScrollAreaContext.md)\>\>

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Context.d.ts:45

#### Inherited from

`Context.Tag("ScrollAreaContext")< ScrollAreaCtx, ScrollAreaContext >().[unifySymbol]`

***

### Identifier

> `readonly` `static` **Identifier**: `ScrollAreaCtx`

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Context.d.ts:35

#### Inherited from

`Context.Tag("ScrollAreaContext")< ScrollAreaCtx, ScrollAreaContext >().Identifier`

***

### key

> `readonly` `static` **key**: `"ScrollAreaContext"`

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Context.d.ts:110

#### Inherited from

`Context.Tag("ScrollAreaContext")< ScrollAreaCtx, ScrollAreaContext >().key`

***

### Service

> `readonly` `static` **Service**: [`ScrollAreaContext`](../interfaces/ScrollAreaContext.md)

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Context.d.ts:34

#### Inherited from

`Context.Tag("ScrollAreaContext")< ScrollAreaCtx, ScrollAreaContext >().Service`
...
`Context.Tag("ScrollAreaContext")< ScrollAreaCtx, ScrollAreaContext >().stack`

## Methods

### \[iterator\]()

> `static` **\[iterator\]**(): `EffectGenerator`\<`Tag`\<`ScrollAreaCtx`, [`ScrollAreaContext`](../interfaces/ScrollAreaContext.md)\>\>

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Effect.d.ts:137

#### Returns

`EffectGenerator`\<`Tag`\<`ScrollAreaCtx`, [`ScrollAreaContext`](../interfaces/ScrollAreaContext.md)\>\>

#### Inherited from

`Context.Tag("ScrollAreaContext")< ScrollAreaCtx, ScrollAreaContext >().[iterator]`
...
`Context.Tag("ScrollAreaContext")< ScrollAreaCtx, ScrollAreaContext >().[NodeInspectSymbol]`

***

### context()

> `static` **context**(`self`): `Context`\<`ScrollAreaCtx`\>
...
`Context`\<`ScrollAreaCtx`\>

#### Inherited from

`Context.Tag("ScrollAreaContext")< ScrollAreaCtx, ScrollAreaContext >().context`

***

### of()

> `static` **of**(`self`): [`ScrollAreaContext`](../interfaces/ScrollAreaContext.md)
...
`Context.Tag("ScrollAreaContext")< ScrollAreaCtx, ScrollAreaContext >().of`
...
`Context.Tag("ScrollAreaContext")< ScrollAreaCtx, ScrollAreaContext >().pipe`
...
`Context.Tag("ScrollAreaContext")< ScrollAreaCtx, ScrollAreaContext >().toJSON`
...
`Context.Tag("ScrollAreaContext")< ScrollAreaCtx, ScrollAreaContext >().toString`
