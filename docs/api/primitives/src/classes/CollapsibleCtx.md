...
[effex-monorepo](../../../modules.md) / [primitives/src](../README.md) / CollapsibleCtx

# Class: CollapsibleCtx

Defined in: [packages/primitives/src/primitives/Collapsible/Collapsible.ts:63](https://github.com/jonlaing/effex/blob/6a1b9c8b38e226609ce7e1a1f5173769b8aad981/packages/primitives/src/primitives/Collapsible/Collapsible.ts#L63)

Effect Context for Collapsible state sharing between parts.

## Extends

- `TagClassShape`\<`"CollapsibleContext"`, [`CollapsibleContext`](../interfaces/CollapsibleContext.md), `this`\>

## Constructors

### Constructor

> **new CollapsibleCtx**(`_`): `CollapsibleCtx`
...
`Context.Tag("CollapsibleContext")< CollapsibleCtx, CollapsibleContext >().constructor`
...
`Context.Tag("CollapsibleContext")< CollapsibleCtx, CollapsibleContext >().[TagTypeId]`

***

### Id

> **Id**: `"CollapsibleContext"`

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Context.d.ts:99

#### Inherited from

`Context.Tag("CollapsibleContext")< CollapsibleCtx, CollapsibleContext >().Id`

***

### Type

> `readonly` **Type**: [`CollapsibleContext`](../interfaces/CollapsibleContext.md)

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Context.d.ts:101

#### Inherited from

`Context.Tag("CollapsibleContext")< CollapsibleCtx, CollapsibleContext >().Type`
...
`Context.Tag("CollapsibleContext")< CollapsibleCtx, CollapsibleContext >()._op`

***

### \[ChannelTypeId\]

> `readonly` `static` **\[ChannelTypeId\]**: `VarianceStruct`\<`never`, `unknown`, `never`, `unknown`, [`CollapsibleContext`](../interfaces/CollapsibleContext.md), `unknown`, `CollapsibleCtx`\>

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Channel.d.ts:108

#### Inherited from

`Context.Tag("CollapsibleContext")< CollapsibleCtx, CollapsibleContext >().[ChannelTypeId]`

***

### \[EffectTypeId\]

> `readonly` `static` **\[EffectTypeId\]**: `VarianceStruct`\<[`CollapsibleContext`](../interfaces/CollapsibleContext.md), `never`, `CollapsibleCtx`\>

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Effect.d.ts:195

#### Inherited from

`Context.Tag("CollapsibleContext")< CollapsibleCtx, CollapsibleContext >().[EffectTypeId]`
...
`Context.Tag("CollapsibleContext")< CollapsibleCtx, CollapsibleContext >().[ignoreSymbol]`

***

### \[SinkTypeId\]

> `readonly` `static` **\[SinkTypeId\]**: `VarianceStruct`\<[`CollapsibleContext`](../interfaces/CollapsibleContext.md), `unknown`, `never`, `never`, `CollapsibleCtx`\>

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Sink.d.ts:82

#### Inherited from

`Context.Tag("CollapsibleContext")< CollapsibleCtx, CollapsibleContext >().[SinkTypeId]`
...
> `readonly` **\_A**: `Covariant`\<[`CollapsibleContext`](../interfaces/CollapsibleContext.md)\>
...
> `readonly` **\_R**: `Covariant`\<`CollapsibleCtx`\>

#### Inherited from

`Context.Tag("CollapsibleContext")< CollapsibleCtx, CollapsibleContext >().[STMTypeId]`

***

### \[StreamTypeId\]

> `readonly` `static` **\[StreamTypeId\]**: `VarianceStruct`\<[`CollapsibleContext`](../interfaces/CollapsibleContext.md), `never`, `CollapsibleCtx`\>

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Stream.d.ts:111

#### Inherited from

`Context.Tag("CollapsibleContext")< CollapsibleCtx, CollapsibleContext >().[StreamTypeId]`
...
> `readonly` **\_Identifier**: `Invariant`\<`CollapsibleCtx`\>

#### \_Service

> `readonly` **\_Service**: `Invariant`\<[`CollapsibleContext`](../interfaces/CollapsibleContext.md)\>
...
`Context.Tag("CollapsibleContext")< CollapsibleCtx, CollapsibleContext >().[typeSymbol]`

***

### \[unifySymbol\]?

> `static` `optional` **\[unifySymbol\]**: `TagUnify`\<`TagClass`\<`CollapsibleCtx`, `"CollapsibleContext"`, [`CollapsibleContext`](../interfaces/CollapsibleContext.md)\>\>

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Context.d.ts:45

#### Inherited from

`Context.Tag("CollapsibleContext")< CollapsibleCtx, CollapsibleContext >().[unifySymbol]`

***

### Identifier

> `readonly` `static` **Identifier**: `CollapsibleCtx`

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Context.d.ts:35

#### Inherited from

`Context.Tag("CollapsibleContext")< CollapsibleCtx, CollapsibleContext >().Identifier`

***

### key

> `readonly` `static` **key**: `"CollapsibleContext"`

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Context.d.ts:110

#### Inherited from

`Context.Tag("CollapsibleContext")< CollapsibleCtx, CollapsibleContext >().key`

***

### Service

> `readonly` `static` **Service**: [`CollapsibleContext`](../interfaces/CollapsibleContext.md)

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Context.d.ts:34

#### Inherited from

`Context.Tag("CollapsibleContext")< CollapsibleCtx, CollapsibleContext >().Service`
...
`Context.Tag("CollapsibleContext")< CollapsibleCtx, CollapsibleContext >().stack`

## Methods

### \[iterator\]()

> `static` **\[iterator\]**(): `EffectGenerator`\<`Tag`\<`CollapsibleCtx`, [`CollapsibleContext`](../interfaces/CollapsibleContext.md)\>\>

Defined in: node\_modules/.pnpm/effect@3.19.9/node\_modules/effect/dist/dts/Effect.d.ts:137

#### Returns

`EffectGenerator`\<`Tag`\<`CollapsibleCtx`, [`CollapsibleContext`](../interfaces/CollapsibleContext.md)\>\>

#### Inherited from

`Context.Tag("CollapsibleContext")< CollapsibleCtx, CollapsibleContext >().[iterator]`
...
`Context.Tag("CollapsibleContext")< CollapsibleCtx, CollapsibleContext >().[NodeInspectSymbol]`

***

### context()

> `static` **context**(`self`): `Context`\<`CollapsibleCtx`\>
...
`Context`\<`CollapsibleCtx`\>

#### Inherited from

`Context.Tag("CollapsibleContext")< CollapsibleCtx, CollapsibleContext >().context`

***

### of()

> `static` **of**(`self`): [`CollapsibleContext`](../interfaces/CollapsibleContext.md)
...
`Context.Tag("CollapsibleContext")< CollapsibleCtx, CollapsibleContext >().of`
...
`Context.Tag("CollapsibleContext")< CollapsibleCtx, CollapsibleContext >().pipe`
...
`Context.Tag("CollapsibleContext")< CollapsibleCtx, CollapsibleContext >().toJSON`
...
`Context.Tag("CollapsibleContext")< CollapsibleCtx, CollapsibleContext >().toString`
