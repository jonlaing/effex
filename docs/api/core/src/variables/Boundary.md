...
[effex-monorepo](../../../modules.md) / [core/src](../README.md) / Boundary
...
> **suspense**: \{\<`N`, `R1`, `EF`\>(`options`): [`Element`](../type-aliases/Element.md)\<`N`, `EF`, `R1`\>; \<`N`, `E`, `R1`, `EF`\>(`options`): [`Element`](../type-aliases/Element.md)\<`N`, `EF`, `R1`\>; \}
