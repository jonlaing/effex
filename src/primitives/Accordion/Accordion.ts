 ...
 */
class AccordionCtx extends Context.Tag("AccordionContext")<
  AccordionCtx,
  AccordionContext
>() {}
 ...
 */
class AccordionItemCtx extends Context.Tag("AccordionItemContext")<
  AccordionItemCtx,
  AccordionItemContext
>() {}
...
export { AccordionCtx, AccordionItemCtx };
